...
#define CALC_LIST_CHECK_SUM(list) (list -> checksum = (31 * ((ptrdiff_t)((list) -> first)) + 28 * ((ptrdiff_t)((list) -> last))))

#define CALC_NODE_CHECK_SUM(node) (node -> checksum = (31 * ((ptrdiff_t)((node) -> prev)) +  28 * ((ptrdiff_t)((node) -> next))))
